        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Menu Principal </a>
                    </li>
                    <h3 class="menu-title">Componentes</h3><!-- /.menu-title -->
                    <li>
                        <a href="banner_listado.php" ><i class="menu-icon fa fa-laptop"></i>Banner</a>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="tables-basic.html">Agregar Nuevo Cliente</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html"></a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <h3 class="menu-title">Iconos</h3><!-- /.menu-title -->
